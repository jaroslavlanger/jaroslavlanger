...
.. https://gist.github.com/tivrfoa/e956f090ff549e9dd04c9ececd3912f1[rust-analyzer with neovim for the Linux Kernel - Rust for Linux]
. https://vim.fandom.com/wiki/Delete_all_lines_containing_a_pattern
. https://github.com/stevearc/oil.nvim
. `:tab split` + `leader n`
. https://vi.stackexchange.com/questions/29145/how-to-color-vim-cmd-output
====
